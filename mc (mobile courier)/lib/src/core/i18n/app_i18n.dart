...
const Map<String, String> _ru = <String, String>{
  ...
  'common.error_with_message': 'Ошибка: {error}',
  'common.yes': 'Да',
  'common.no': 'Нет',
  ...
  'shift.close.default_note': 'Обычное закрытие из мобильного',
  ...
  'warehouse.handover.title': 'Сдача курьера на склад',
  'warehouse.handover.courier': 'Курьер: {name}',
  'warehouse.handover.active_tasks': 'Заказов у курьера на руках: {count}',
  'warehouse.handover.note_hint': 'Комментарий для приемщика склада',
  'warehouse.handover.started': 'Сессия сдачи начата',
  'warehouse.handover.start': 'Начать сдачу',
  'warehouse.queue.title': 'Статус очереди',
  'warehouse.queue.pending_events': 'Событий в офлайн-очереди: {count}',
...
const Map<String, String> _az = <String, String>{
  ...
  'common.error_with_message': 'Xəta: {error}',
  'common.yes': 'Bəli',
  'common.no': 'Xeyr',
  ...
  'shift.close.default_note': 'Mobil tətbiqdən adi bağlanma',
  ...
  'warehouse.handover.title': 'Kuryerin anbara təhvili',
  'warehouse.handover.courier': 'Kuryer: {name}',
  'warehouse.handover.active_tasks': 'Kuryerin üzərindəki sifarişlər: {count}',
  'warehouse.handover.note_hint': 'Anbar qəbulçusu üçün şərh',
  'warehouse.handover.started': 'Təhvil sessiyası başladı',
  'warehouse.handover.start': 'Təhvili başlat',
  'warehouse.queue.title': 'Növbə statusu',
  'warehouse.queue.pending_events': 'Oflayn növbədə hadisələr: {count}',
